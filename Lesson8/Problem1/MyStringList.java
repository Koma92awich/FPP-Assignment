...
public class MyStringList {
	...
	public static void main(String[] args) {
		...
		System.out.println("Data before sort: " + strList);

		strList.sort();
		System.out.println("Data after sort: " + strList);

		System.out.println("Searching for 'number': " + strList.search("number"));
		System.out.println("Searching for 'tiny': " + strList.search("tiny"));
	}
